# V-14 theme for oh-my-zsh
# Intended to be used with Snazzy: https://github.com/sindresorhus/hyper-snazzy
...
# %B sets bold text
PROMPT=$'
%{$C%}%2~ $(custom_git_prompt)%{$RESET%}[%B%{$M%}%n%{$Y%}@%{$G%}%m%b%{$RESET%}]
$PROMPTCOLOR%B$PROMPTPREFIX%b%{$RESET%} '
RPS1="${return_code}"

ZSH_THEME_GIT_PROMPT_PREFIX="%{$B%}|%{$RESET%}"
